# source: https://github.com/dataquestio/analytics_pipeline/blob/master/log_generator.py
...
# This function aims to generate the fake log files
def generate_log_line():
    """
    This function aims to generate the fake log files
    :return: log_line, a simulated line of logging to an specific website generated by fake data
    """
    fake = Faker()
    now = datetime.now()
